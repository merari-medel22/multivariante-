...
# Encontrar la proporcion de varianza explicada. Se interpreta de tal forma que el número cercanos a 1, el factor explica mejor la variable.
...
# La unicidad es el cuadrado del coeficiente del factor único y se expresa como la porción de la varianza explicada por el factor único. Quiere decir que no se puede explicar por otros.
...
# Interpretación
# Para esto se utiliza un gráfico de arbol
